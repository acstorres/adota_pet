...
public class CadastrarPetVM {
	...
	public void init() {
		...
		if (Sessions.getCurrent().getAttribute("usuario") == null) {
			...
			animal = AnimalBuilder.umNovoAnimal().definidoAutomaticamentePelaDataCadastro().constroi();
	...
	public void salvarPet() {
		...
		if (animalSessionBeanFacadeLocal.include(animal) != null) {
			...
			Clients.showNotification("Erro ao salvar Pet!", Clients.NOTIFICATION_TYPE_WARNING, null, null, 3000,
					true);
			return;
		}
